...
def main():
    ...
    st.subheader("This study is mainly confined to the s tock market behavior and is                 intended to devise certain techniques for investors to make reasonable                returns from investments .")
    
    st.subheader("Though there were a number of studies , which                deal with analysis of stock price behaviours , the use of control chart                techniques and fai lure time analysis would be new to the investors. The                concept of stock price elast icity,                introduced in this study, will be a good                tool to measure the sensitivity of stock price movements.")
    
    st.subheader("In this study,                  Predictions for the close price is suggested for the National Stock Exchange index,                Nifty,                based on Long Short Term Based (LSTM)                method.") 
    
    st.subheader("We make predictions based on the last 30 days Closing price data                which we fetch from NSE India website in realtime.")
    
    st.markdown("Note: This is just a fun project, No one can predict the         stock market as of today because there are a        lot of factors which needs to be considered             before makaing any investments, especially in StockMarket.            So it is advisable now to indulge in any                 bad decisions based on the predictions shown here.")
